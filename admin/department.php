	                                      ...
	                                      <div class="col-md-12">
												<div class="form-group label-floating">
													...
													<select id="faculty" name="faculty"class="form-control" >                                                       
                                                      ...
                                                      <option>Faculty Applied and Health Sciences</option>
                                                      <option>Institute of Computing and Informatics</option>
                                                      <option>Institute of Research Innovation and Extension</option>
                                                      <option>School of Business</option>
                                                      <option>School of Humanities and Social Studies</option>
                                                    </select>
												</div>
	                                        </div>
	                                    </div>                                        
